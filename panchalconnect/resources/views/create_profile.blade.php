                                            ...
                                            <td class="day_value">
                                                <div class="inputText_block1">
                                                    <div id="divAnnualIncome" style="display: none">
                                                        <input class="optional valid" type="text" name="annual_income" id="annual_income" oninput="this.className = ''" onblur="validateNumber('annual_income')"> (Rs.)
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <table class="table_working_hours">
                                    <tbody>
                                        ...
                                        <tr class="opened_1">
                                            ...
                                            <td class="day_value">
                                                <div class="inputText_block1">
                                                    <input class="optional valid" type="text" name="father_annual_income" id="father_annual_income" oninput="this.className = ''" onblur="validateNumber('father_annual_income')"> (Rs.)
                                                </div>
                                                <div style="color:#999; font-size:0.85em;">
                                ...
                                <table class="table_working_hours">
                                    <tbody>
                                        ...
                                        <tr class="opened_1">
                                            ...
                                            <td class="day_value">
                                                <div class="inputText_block1">
                                                    <input class="optional valid" type="text" name="mother_annual_income" id="mother_annual_income" oninput="this.className = ''" onblur="validateNumber('mother_annual_income')"> (Rs.)
                                                </div>
                                                <div style="color:#999; font-size:0.85em;">
                                                    Give 0 if not available
                                                </div>
